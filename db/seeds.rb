...
artistOne = user.artists.create!(artist_name: 'ED', first_name: 'Edgar', last_name: 'Degas', email: 'edgardegas@yahoo.com', password: 'password', street: '2625 Ashcraft', city: 'San Diego',state: 'CA',zipcode: '92103',website: 'www.edgardegas.com',price: '$', phone: '(760)210-1326')
artistTwo = user.artists.create!(artist_name: 'CP', first_name: 'Camille', last_name: 'Pissaro', email: 'camillepissaro@gmail.com', password: 'password', street: '2575 Willison Street',city: 'San Diego',state: 'CA',zipcode: '92111',website: 'www.camillepissaro.com',price: '$$$', phone: '(858)352-0001')
artistThree = user.artists.create!(artist_name: 'MC', first_name: 'Marc', last_name: 'Chagall', email: 'marcchagall@yahoo.com', password: 'password', street: '3484 Coleman Avenue',city: 'San Diego',state: 'CA',zipcode: '92103',website: 'www.marcchagall.com',price: '$', phone: '(858)541-6026')
artistFour = user.artists.create!(artist_name: 'MCA', first_name: 'Mary', last_name: 'Cassatt', email: 'marycassatt@gmail.com', password: 'password', street: '4003 Poplar Avenue',city: 'San Diego',state: 'CA',zipcode: '92111',website: 'www.marycassatt.com',price: '$$$', phone: '(760)522-5363')
artistFive = user.artists.create!(artist_name: 'PG', first_name: 'Paul', last_name: 'Gauguin', email: 'paulgauguin@yahoo.com', password: 'password', street: '480 Poplar Avenue',city: 'San Diego',state: 'CA',zipcode: '92103',website: 'www.paulgauguin.com',price: '$$', phone: '(619)515-5115')
